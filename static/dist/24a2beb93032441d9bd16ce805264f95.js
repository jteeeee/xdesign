...
var FILL_FN = function(d, o) {
    ...
    if ((typeof d == "object" && d['target'] > 0.5) || d === "isTarget" || (typeof d == "boolean" && d)) {
        return "rgba(51,133,180," + o + ")";
    } else {
        return "rgba(139,18,155," + o + ")";
    }
}
